...
const WhoShouldAttend = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8 space-y-6">
      <h2 className="sm:text-4xl text-center text-[#FF4D31] text-lg font-bold capitalize">Who Should Attend?</h2>
      {whoShouldAttendContent.map((content, index) => (
        <div key={index} className="space-y-2">
          <h3 className="text-xl font-semibold text-[#27448D]">{content.subheading}</h3>
